...
A semi-fork of Apache Creadur Rat Core module, intended for analyzing file headers for license information.
This fork will add to the licenses that can be identified.
This code is based on Apache technology.

Readme for original apache-rat
==============================
